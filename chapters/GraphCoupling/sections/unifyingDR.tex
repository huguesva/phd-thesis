...
\end{align*}
which is the loss function considered in UMAP \cite{mcinnes2018umap}, the construction of $\widetilde{\mW}_{X}$ being borrowed from section 3.1 of the paper.
