...
Some data modalities are more conducive to providing a meaningful distance metric. This is evident, for example, in single-cell genomics \citep{amir2013visne}, where variations in gene expression capture biologically significant information (see, \eg \Cref{fig:intro_fig}). This characteristic partly explains the popularity of dimensionality reduction (DR) methods in this field \citep{kobak2019art}.
